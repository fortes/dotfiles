...
" nvim: lazyredraw causes visual artifacts with floating windows / async UI
if !has('nvim')
  set lazyredraw
endif
...
" Floating window / popup border style
if exists('+winborder')
...
" Search within subfolders by default (noise filtered via wildignore below)
set path+=**
